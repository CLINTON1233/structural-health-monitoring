...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-800 via-blue-900 to-blue-950 relative overflow-hidden">
        ...
        <!-- Navigation -->
        <nav class="relative z-10 px-3 sm:px-6 md:px-12 py-3 sm:py-4 md:py-6">
            <div class="flex flex-col sm:flex-row justify-between items-center max-w-7xl mx-auto">
                ...
                <div class="flex space-x-2 sm:space-x-4 mt-2 sm:mt-0">
                    ...
                    <a href="{{ route('login') }}" class="text-white hover:text-blue-200 px-3 sm:px-4 py-1 sm:py-2 transition-colors duration-200 font-semibold text-sm sm:text-base">
                        LOG IN
                    </a>
        ...
        <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div class="text-[20rem] md:text-[25rem] lg:text-[30rem] font-black text-white opacity-10 leading-none select-none">
                SHM
            </div>
        </div>
        ...
        <div class="relative z-10 flex items-center justify-center min-h-[calc(100vh-100px)] px-4 sm:px-6">
            <!-- Signup Form -->
            <div class="bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 w-full max-w-xs sm:max-w-sm">
                <!-- Title -->
                <div class="text-center mb-3 sm:mb-4">
                    <h2 class="text-lg sm:text-xl md:text-2xl font-bold text-black">SIGN UP</h2>
                </div>

                <form method="POST" action="{{ route('signup.post') }}" class="space-y-2 sm:space-y-3">
                    @csrf

                    <!-- Name Field -->
                    <div>
                        <label class="block text-black text-sm sm:text-base mb-1">Full Name</label>
                        <input
                            type="text"
                            name="name"
                            id="name"
                    ...
                    <div>
                        <label class="block text-black text-sm sm:text-base mb-1">Confirm Password</label>
                        <input
                            type="password"
                    ...
                    <div class="text-center pt-2 sm:pt-3">
                        <p class="text-gray-600 text-xs sm:text-sm mb-1">Already have an account?</p>
                        <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800 font-medium text-xs sm:text-sm underline transition-colors duration-200">
                            Log In
                        </a>
                    </div>
                </form>
